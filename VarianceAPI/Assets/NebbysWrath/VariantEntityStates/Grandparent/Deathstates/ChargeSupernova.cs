...
namespace NebbysWrath.VariantEntityStates.Grandparent.DeathStates
{
    public class Supernova : BaseState
    {
        public static float baseDuration = 5;

        public static GameObject chargingEffectPrefab = MainClass.nebbysWrathAssets.LoadAsset<GameObject>("ChargeSuperNova");

        public static GameObject areaIndicatorPrefab = MainClass.nebbysWrathAssets.LoadAsset<GameObject>("SuperNovaAreaIndicator");
