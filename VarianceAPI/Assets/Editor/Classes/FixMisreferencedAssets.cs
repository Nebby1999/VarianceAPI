...
using UnityEngine;
using VAPIEditor.Classes;

namespace VarianceAPI.Classes
{
    ...
    public class FixMisreferencedAssets : PipelineJob
    {
        public override void Execute(Pipeline pipeline)
        {
            var data = pipeline.Manifest.Data.OfType<MissreferencedScriptableObjects>().ToArray();
            var unityObjects = data
                .SelectMany(upd => upd.MisreferencedAssets)
