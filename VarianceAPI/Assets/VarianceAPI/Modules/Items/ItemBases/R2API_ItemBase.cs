...
{
    /// <summary>
    /// Code taken from KomradeSpectre's ItemModCreationBoilerplate.
    /// <para>Not many things in here are needed for thunderkit items.</para>
    /// <para>Most of these are here in case someone creates an item using R2API.</para>
    /// </summary>
    public abstract class R2API_ItemBase
    {
